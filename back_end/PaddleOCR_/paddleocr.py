...
tools_ = importlib.import_module('.', 'tools_')
ppocr_ = importlib.import_module('.', 'ppocr_')
ppstructure = importlib.import_module('.', 'ppstructure')

from tools_.infer import predict_system
from ppocr_.utils.logging import get_logger

logger = get_logger()
from ppocr_.utils.utility import check_and_read, get_image_file_list
from ppocr_.utils.network import maybe_download, download_with_progressbar, is_link, confirm_model_dir_url
        ...
        'PP-OCR': {
            ...
            'rec': {
                ...
                'french': {
                    ...
                    'dict_path': './ppocr_/utils/dict/french_dict.txt'
                },
                'german': {
                    'url':
                    'https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/german_mobile_v2.0_rec_infer.tar',
                    'dict_path': './ppocr_/utils/dict/german_dict.txt'
                },
                'korean': {
                    'url':
                ...
                'structure': {
                    ...
                    'dict_path': 'ppocr_/utils/dict/table_dict.txt'
                }
            },
            'cls': {
                'ch': {
        ...
        'PP-Structure': {
            'table': {
                'en': {
                    ...
                    'dict_path': 'ppocr_/utils/dict/table_structure_dict.txt'
                }
            }
        },
        'PP-Structurev2': {
            'table': {
                ...
                'ch': {
                    ...
                    'dict_path': 'ppocr_/utils/dict/table_structure_dict_ch.txt'
                }
            },
            'layout': {
                'en': {
                    ...
                    'dict_path':
                    'ppocr_/utils/dict/layout_dict/layout_publaynet_dict.txt'
                },
                'ch': {
                    'url':
                    'https://paddleocr.bj.bcebos.com/ppstructure/models/layout/picodet_lcnet_x1_0_fgd_layout_cdla_infer.tar',
                    'dict_path':
                    'ppocr_/utils/dict/layout_dict/layout_cdla_dict.txt'
                }
            }
        }
    }
