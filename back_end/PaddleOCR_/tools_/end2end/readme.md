...
python3 tools_/end2end/convert_ppocr_label.py --mode=pred --label_path=path/to/pred_txt --save_folder=save_ppocr_V2_infer
```
...
```
python3 tools_/eval_end2end.py ./save_gt_label/ ./save_ppocr_V2_infer/
```
