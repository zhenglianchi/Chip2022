...
from ppocr_.utils.stats import TrainingStats
from ppocr_.utils.save_load import save_model
from ppocr_.utils.utility import print_dict, AverageMeter
from ppocr_.utils.logging import get_logger
from ppocr_.utils.loggers import VDLLogger, WandbLogger, Loggers
from ppocr_.utils import profiler
from ppocr_.data import build_dataloader
...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", help="configuration file to use",default="PaddleOCR_/config.yml")
        self.add_argument(
