...
void ppocr_::det(cv::Mat img, std::vector<OCRPredictResult> &ocr_results,
...
void ppocr_::rec(std::vector<cv::Mat> img_list,
...
void ppocr_::cls(std::vector<cv::Mat> img_list,
                std::vector<OCRPredictResult> &ocr_results,
                std::vector<double> &times) {
...
ppocr_::ocr(std::vector<cv::String> cv_all_img_names, bool det, bool rec,
           bool cls) {
...
void ppocr_::log(std::vector<double> &det_times, std::vector<double> &rec_times,
