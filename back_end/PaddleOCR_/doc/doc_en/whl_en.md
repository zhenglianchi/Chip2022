...
## 2 Use
### 2.1 Use by code
The paddleocr whl package will automatically download the ppocr_ lightweight model as the default model, which can be customized and replaced according to the section 3 **Custom Model**.
...
| rec_char_dict_path      | the alphabet path which needs to be modified to your own path when `rec_model_Name` use mode 2                                                                                                                                              | ./ppocr_/utils/ppocr_keys_v1.txt                        |
...
| det                     | Enable detction when `ppocr_.ocr` func exec                                                                                                                                                                                                   | TRUE                    |
| rec                     | Enable recognition when `ppocr_.ocr` func exec                                                                                                                                                                                                   | TRUE                    |
| cls                     | Enable classification when `ppocr_.ocr` func exec((Use use_angle_cls in command line mode to control whether to start classification in the forward direction)                                                                                                                                                                                                   | FALSE                    |
