...
- 2022.5.9 release PaddleOCR v2.5, including:
    ...
    - [ppocr_Labelv2](../../ppocr_Label): Add the annotation function for table recognition task, key information extraction task and irregular text image.
...
- 2020.11.25 Update a new data annotation tool, i.e., [ppocr_Label](../../ppocr_Label/README.md), which is helpful to improve the labeling efficiency. Moreover, the labeling results can be used in training of the PP-OCR system directly.
...
- 2020.7.15, Add several related datasets, data annotation and synthesis tools_.
