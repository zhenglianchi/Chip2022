...
|  rec_char_dict_path | str | "./ppocr_/utils/ppocr_keys_v1.txt" | character dictionary file |
...
|  e2e_char_dict_path | str | "./ppocr_/utils/ic15_dict.txt" | Recognition dictionary file path |
