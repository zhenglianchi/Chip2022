...
- 统一命名：如PP-OCRv2、PP-OCR mobile、`paddleocr` whl包、ppocr_Label、Paddle Lite等
...
将remote分支改成 `https://oauth2:{token}@github.com/{your_name}/PaddleOCR.git`。例如：如果token值为12345，你的用户名为ppocr_，则运行下方命令
