...
|      character_dict_path |    设置字典路径            |  ./ppocr_/utils/ppocr_keys_v1.txt  | 如果为空，则默认使用小写字母+数字作为字典 |
...
|         字段             |      用途       |      默认值      |            备注             |
| :---------------------: |:-------------:|:-------------:|   :--------------------:   |
|      name        |     优化器类名     |     Adam      |  目前支持`Momentum`,`Adam`,`RMSProp`, 见[ppocr_/optimizer/optimizer.py](../../ppocr_/optimizer/optimizer.py)  |
|      beta1           | 设置一阶矩估计的指数衰减率 |      0.9      |               \             |
|      beta2           | 设置二阶矩估计的指数衰减率 |     0.999     |               \             |
|      clip_norm           |  所允许的二范数最大值   |               |               \             |
|      **lr**                | 设置学习率decay方式  |       -       |       \  |
|        name    |  学习率decay类名   |    Cosine     | 目前支持`Linear`,`Cosine`,`Step`,`Piecewise`, 见[ppocr_/optimizer/learning_rate.py](../../ppocr_/optimizer/learning_rate.py) |
|        learning_rate      |     基础学习率     |     0.001     |  \        |
|      **regularizer**      |   设置网络正则化方式   |       -       | \        |
|        name      |     正则化类名     |      L2       | 目前支持`L1`,`L2`, 见[ppocr_/optimizer/regularizer.py](../../ppocr_/optimizer/regularizer.py)        |
...
|      **Transform**           |    设置变换方式  |       -       |               目前仅rec类型的算法支持, 具体见[ppocr_/modeling/transforms](../../ppocr_/modeling/transforms)              |
|        name    |      变换方式类名   |         TPS       | 目前支持`TPS` |
|        num_fiducial      |    TPS控制点数        |       20      |  上下边各十个       |
|        loc_lr      |    定位网络学习率        |       0.1      |  \      |
|        model_name      |    定位网络大小        |       small      |  目前支持`small`,`large`       |
|      **Backbone**      |  设置网络backbone类名        |       -      | 具体见[ppocr_/modeling/backbones](../../ppocr_/modeling/backbones)        |
...
|      **Neck**      |  设置网络neck        |       -      | 具体见[ppocr_/modeling/necks](../../ppocr_/modeling/necks)        |
...
|      **Head**      |  设置网络Head        |       -      | 具体见[ppocr_/modeling/heads](../../ppocr_/modeling/heads)        |
...
|      transforms        |        对图片和标签进行变换的方法列表         |  [DecodeImage,CTCLabelEncode,RecResizeImg,KeepKeys] |   见[ppocr_/data/imaug](../../ppocr_/data/imaug)  |
|      **loader**        |        dataloader相关         |  - |   |
