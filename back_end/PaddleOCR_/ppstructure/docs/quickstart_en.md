...
| table_char_dict_path | The dictionary path of table structure model | ../ppocr_/utils/dict/table_structure_dict.txt  |
...
| layout_dict_path  | The dictionary path of layout analysis model| ../ppocr_/utils/dict/layout_publaynet_dict.txt |
