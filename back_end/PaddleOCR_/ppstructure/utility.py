...
import numpy as np
from tools_.infer.utility import draw_ocr_box_txt, str2bool, init_args as infer_args
...
def init_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="../ppocr_/utils/dict/table_structure_dict.txt")
    # params for layout
    parser.add_argument("--layout_model_dir", type=str)
    parser.add_argument(
        "--layout_dict_path",
        type=str,
        default="../ppocr_/utils/dict/layout_dict/layout_publaynet_dict.txt")
    parser.add_argument(
