...
# 字典初始化 
bihuashuDict = initDict('correction/db/bihuashu_2w.txt');
hanzijiegouDict = initDict('correction/db/hanzijiegou_2w.txt');
pianpangbushouDict = initDict('correction/db/pianpangbushou_2w.txt');
sijiaobianmaDict = initDict('correction/db/sijiaobianma_2w.txt');
